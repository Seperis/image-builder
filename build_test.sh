...
echo "Configuration file: $my_build.conf"
echo "Script file: $sh_file"
...
if [ -e deploy/$build_name ]; then
	...
	echo "sudo ./setup_sdcard.sh --img-$img_size $img_name $opt_tags 2>&1 | tee $sdlog"
